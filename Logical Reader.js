...
// Edge and Microsoft
logic("Microsoft recommends using Microsoft Edge for a fast, secure, and modern web experience that can help save you time and money.", "Microsoft begs you. Please try Edge. It's a browser too.",1);
...
logic("How Firefox compares to other browsers", "Firefox Vs. Chrome + Edge",1);
...
logic("we don’t even require your email address to download.", "no email needed to download",1);
logic("That’s because unlike other browsers, we have no financial stake in following you around the web.", "Becuase we don't make money on data.",1);
logic(" with tools", ", use tools,",1);
logic("Choose your Colors", "See Colors",1);
logic("Personalize your experience with new colorways.", "Choose your colours",1);
logic("An extra layer of protection", "Secure",1);
logic("helps keep internet service providers from selling your data.", "prevents ISP's from selling data.",1);
...
logic("recoomendation settings", "default settings",1);
logic("Developer", "Programmer",1);
logic("Pop a video out of the browser window so you can stream and multitask.", "Stream and multitask.",1)
}
...
function removeImages() {// var imageCount = 
}
...
logic("No shady privacy policies or back doors for advertisers.", "Comes fineprint and Spyware free.", 1);
logic("Just a lightning fast browser that doesn’t sell you out.", "Fast and won't sell your data.", 1);
logic("over 90", "90+", 1);
logic("no matter", "with", 1);
logic("no matter what you’re using", "if your an addict", 1);
logic("Your download should begin automatically", "File Processed automatically", 1);
...
logic("and compatible with Windows, Mac and Linux machines", "cross-platform", 1);
